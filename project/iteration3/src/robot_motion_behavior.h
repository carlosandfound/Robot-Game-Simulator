...
#ifndef PROJECT_ITERATION3_SRC_ROBOT_MOTION_BEHAVIOR_H_
#define PROJECT_ITERATION3_SRC_ROBOT_MOTION_BEHAVIOR_H_
...
#endif  // PROJECT_ITERATION3_SRC_ROBOT_MOTION_BEHAVIOR_H_
