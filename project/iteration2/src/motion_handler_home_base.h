...
#ifndef PROJECT_ITERATION2_SRC_MOTION_HANDLER_HOME_BASE_H_
#define PROJECT_ITERATION2_SRC_MOTION_HANDLER_HOME_BASE_H_
...
#endif   // PROJECT_ITERATION2_SRC_MOTION_HANDLER_HOME_BASE_H_
